...
class SlidingWindowMaximum {
    ...
    //输入 [1,3,-1,-3,5,3,6,7],3输出:    [3,3,5,5,6,7]
        int[] nums = {1,3,-1,-3,5,3,6,7};
        System.out.println("result  = " + Arrays.toString(maxSlidingWindow(nums, 3)));
    }

    /*
解题思路遍历数组，将 数 存放在双向队列中，并用 L,R 来标记窗口的左边界和右边界。队列中保存的并不是真的 数，
...
作者：hanyuhuang
链接：https://leetcode.cn/problems/sliding-window-maximum/solution/shuang-xiang-dui-lie-jie-jue-hua-dong-chuang-kou-2/
    * */
